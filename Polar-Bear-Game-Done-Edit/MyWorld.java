...
public class MyWorld extends World
{
    ...
    {    
        ...
        setActOrder(rock_3.class, clouds_2.class, rocks_1.class, clouds_3.class, rocks_2.class, clouds_4.class, Tree.class, bear.class);
        addObject(new rock_3(), 480, 270);
        addObject(new rock_3(), 1440, 270);
